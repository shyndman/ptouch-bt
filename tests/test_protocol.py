...
from ptouch_bt import FinalizeMode, ImageFit, LabelColor, PTouchPrinter, Status, build_image_print_job, build_print_job, build_test_print_job, build_text_print_job, label_color_name, prepare_image, render_text_image
...
class ProtocolTests(unittest.TestCase):
    def test_status_decodes_observed_response(self):
        status = Status.from_bytes(bytes.fromhex("802042307630000000000c010000000000000000000000000108000000000000"))
    ...
    def test_packbits_fake_uncompressed_line_shape(self):
        ...
        self.assertEqual(packbits_raster_line(rasterline), bytes.fromhex("4711000f000102030405060708090a0b0c0d0e0f"))
    ...
    def test_printer_builds_text_jobs_without_hardware(self):
        ...
        job = printer.text_job("Text", tape_width=tape_width_px(12), finalize=FinalizeMode.FEED_CUT)
    ...
    def test_image_print_job_accepts_path_like_source(self):
        with TemporaryDirectory() as directory:
            ...
            job = build_image_print_job(path, tape_width_px(12), finalize=FinalizeMode.CHAIN, dither=False)
    ...
    def test_printer_builds_image_jobs_without_hardware(self):
        ...
        job = printer.image_job(source, tape_width=tape_width_px(12), finalize=FinalizeMode.FEED_CUT, dither=False)
